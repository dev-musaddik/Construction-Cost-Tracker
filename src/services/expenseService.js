...
const API_URL = "https://construction-cost-tracker-server-g2xg-4mnituoop.vercel.app/api/expenses"; // <- no trailing slash (we'll add it per call)
...
const createExpense = async (description, amount, category, date) => {
